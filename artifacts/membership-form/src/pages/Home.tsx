...
export default function Home() {
  const [entryStage, setEntryStage] = useState<"loading" | "welcome" | "form">(
    "loading",
  );
...
>>>>>>> eebfcb0e6051256be9f95ca9d80b4321cd4f353b
  ...
  const uploadPhoto = async (
    ...
    try {
      ...
      await fetch(
        `${base}/api/membership-applications/${applicationId}/photo`,
        {
          method: "PATCH",
          headers: {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    const finalData = {
      ...
      numberOfChildren:
        apiData.numberOfChildren === 0 ? undefined : apiData.numberOfChildren,
    ...
    createApplication.mutate(
      { data: finalData },
      {
        onSuccess: async (result) => {
          ...
          const uploadToken = (
            result as typeof result & { photoUploadToken?: string }
          ).photoUploadToken;
        ...
        <section className="relative flex w-full max-w-md flex-col items-center justify-center text-center">
          ...
          {entryStage === "loading" ? (
            <>
              ...
              <p
                className="mt-7 min-h-6 text-sm font-semibold text-muted-foreground"
                aria-live="polite"
              >
                {
                  LOADING_MESSAGES[
                    Math.floor((3 - countdown) / 2) % LOADING_MESSAGES.length
                  ]
                }
              </p>
            </>
            ...
            <div className="mt-10 animate-in fade-in slide-in-from-bottom-3 duration-500">
              ...
              <p className="mx-auto mt-4 max-w-sm text-base leading-7 text-muted-foreground">
                A few thoughtful questions help us connect you with the right
        ...
        <Card className="w-full border-primary/20 shadow-lg text-center py-12">
          <CardHeader>
            ...
            <CardDescription className="text-lg mt-2">
              Thank you for applying to the Bong County Women and Youth
              Development Cooperration.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-md mx-auto mt-4">
              Please save this reference number. Our team will contact you
              regarding the next steps in the membership process.
            </p>
          </CardContent>
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8 sm:py-12">
        <div className="mb-8 border-b border-border/70 pb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
            Tell us about yourself and how you would like to take part in the
            Bong County Women and Youth Development Cooperation.
          </p>
          <div
            className="mx-auto mt-6 h-1 w-14 bg-primary"
            aria-hidden="true"
          />
        </div>
        ...
        <Form {...form}>
          <form
            ...
            className="reference-form space-y-10"
          >
            ...
            <Card className="overflow-visible rounded-none border-0 bg-transparent shadow-none">
              <CardHeader className="border-b border-border/70 px-0 py-0 pb-3">
                ...
                <CardDescription className="mt-1 text-sm">
                  Your primary contact and location information.
                </CardDescription>
              </CardHeader>
                    ...
                    <FormItem>
                      ...
                      {form.watch("countryState") === "Liberia" ? (
                        ...
                        >
                          ...
                          <SelectContent>
                            {(
                              LIBERIA_DISTRICTS[form.watch("county")] ?? []
                            ).map((district) => (
...
>>>>>>> eebfcb0e6051256be9f95ca9d80b4321cd4f353b
                ...
                <div className="md:col-span-2">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      JPG, PNG or WEBP. You may also submit your photo later
...
>>>>>>> eebfcb0e6051256be9f95ca9d80b4321cd4f353b
              ...
              <Card className="overflow-visible rounded-none border-0 bg-transparent shadow-none">
                <CardHeader className="border-b border-border/70 px-0 py-0 pb-3">
                  ...
                  <CardDescription className="mt-1 text-sm">
                    Select every area you’d like to explore.
                  </CardDescription>
                </CardHeader>
                <CardContent className="px-0 py-6">
                  <FormField
                      ...
                      <FormItem>
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            {
                              id: "AB",
                              label: "Group Participation & Development",
                            },
                            {
                              id: "AC",
                              label: "Personal Development and Training",
                            },
                            { id: "AD", label: "Volunteerism" },
                            { id: "AE", label: "General Benefits" },
                          ].map((item) => (
...
<<<<<<< HEAD
            ...
            <Card className="overflow-visible rounded-none border-0 bg-transparent shadow-none">
              <CardHeader className="border-b border-border/70 px-0 py-0 pb-3">
                ...
                <CardDescription className="mt-1 text-sm">
                  One last review, then you’re ready to submit.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6 px-0 py-6">
                <div className="border border-border/70 bg-muted/20 p-4 text-sm leading-relaxed text-muted-foreground">
                  "I hereby agree to be a member of the Bong County Women and
                  Youth Cooperation (BWYDC). I have completed the Introductory
                  meeting prescribed for prospective members, and I understand
                  the purpose and/or objectives of this cooperation. I agree to:
                  comply with the Cooperation's Guiding Principles and By-Laws;
                  attend meetings, conferences and/or seminars; and participate
                  in the planned savings program."
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Your town/city of residence"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="md:col-span-2">
                        ...
                        <FormControl>
                          <Input
                            placeholder="Planned contribution details"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                      ...
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-2xl border border-primary/25 bg-primary/[0.04] p-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <FormDescription>
                            ...
                            and you agree to the membership terms.
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
